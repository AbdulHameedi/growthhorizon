            ...
            <div class="flex justify-between py-5">
                ...
                <div class="flex items-center gap-4 text-gray-600">
                    ...
                    <div class="relative max-[570px]:static">
                        ...
                        <div v-if="notificationBox" class="z-20 absolute bg-white shadow-md rounded-md w-[400px] text-gray-600 right-5 bottom-[-28rem] max-[570px]:fixed max-[570px]:bottom-0 max-[570px]:w-full max-[570px]:right-0">
                    ...
                    <div class="relative max-[570px]:hidden">
                        ...
                        <div v-if="userBox" class="z-20 py-5 text-gray-600 absolute shadow-md top-10 bg-white rounded-md right-0 w-[250px]">
